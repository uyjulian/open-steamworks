...
#ifndef ISTEAMINVENTORY003_H
#define ISTEAMINVENTORY003_H
#ifdef _WIN32
#pragma once
#endif
...
public:										
	...
	virtual SteamAPICall_t StartPurchase( const SteamItemDef_t *pArrayItemDefs, const uint32 *punArrayQuantity, uint32 unArrayLength ) = 0;
	...
	virtual bool GetItemsWithPrices( SteamItemDef_t *pArrayItemDefs,
